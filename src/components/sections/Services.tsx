...
const services = [
  {
    ...
    duration: "1 сессия",
    description: "Поиск того, что запустило боль, тревогу или апатию. Это не просто диагностика, а полноценный сеанс с мгновенной работой.",
  },
  {
    title: "Нейродинамическое восстановление",
    duration: "Пакет из 3 сессий",
    description: "Работа с целями, апатией и состояниями «хочу, но не получается». Мягко допроживаем заблокированные эмоции, истощаем негативные сценарии и освобождаем ресурс.",
  },
  {
