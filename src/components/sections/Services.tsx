...
const services = [
  ...
  {
    title: "Работа с болью и жалобами",
    duration: "",
    description: "Работа с жалобами в любом регионе тела, вызванных прямой травмой, с формулировками «почему-то болит», восстановление после операций по мышечно-связочному механизму.",
  },
  {
    title: "Психоэмоциональная коррекция",
    duration: "",
    description: "Через мягкий кинезиологический тест находим и возвращаем контакт с миром и с собой, перенаправляя человека в настоящее без застревания в драмах и неудачах прошлого.",
  },
  {
  ...
  {
    title: "Работа со шрамами, переломами, ожогами и татуировками",
    duration: "3 сессии",
        ...
        <div className="max-w-3xl mb-16">
          <FadeIn>
            ...
            <p className="text-xl text-graphite/70 font-light">
              Стоимость и количество сессий зависят от вашего запроса. Оставьте заявку, и мы подберем оптимальный маршрут.
            </p>
          </FadeIn>
        </div>
