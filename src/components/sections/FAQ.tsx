...
const faqs = [
  ...
  {
    question: "Вы врач?",
    answer: "Я специалист по оздоровлению и кинезиологии. Я не ставлю медицинские диагнозы и не лечу болезни таблетками — я помогаю вашему организму найти первопричину сбоя и включить внутренние ресурсы для восстановления."
  },
  {
  ...
  },
  {
    ...
    answer: "Да, метод абсолютно безопасен, безболезнен и экологичен. Он отлично работает с детскими нарушениями осанки, тревожностями, заиканием, энурезом и дисбалансами в развитии, так как воздействует на уровне нервной системы мягко и без стресса."
  },
  {
    question: "В чем отличие от классического массажа или остеопатии?",
