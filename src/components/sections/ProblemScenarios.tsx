        ...
        <div>
          ...
          <FadeIn>
            ...
            <p className="text-xl text-graphite/70 font-light">
              Часто боль становится просто фоном жизни. Человек из сильного и уверенного превращается в того, кого сам не узнает, цели и мотивы действовать уходят, а походы по специалистам дают лишь временный эффект. Узнаете свою ситуацию?
            </p>
          </FadeIn>
        </div>
