...
const cases = [
  {
    ...
    description: "Сильнейшее истощение, депрессия, практически не ходил. После мягкой работы появились силы, вскопал грядку, начал строить планы на будущее. «Болезнь разжала свои тиски».",
  },
  {
  ...
  },
  {
    ...
    description: "Девушка 14 лет (энурез): узи и анализы в норме, эффекта от врачей не было — проблема полностью решена. Ребенок 11 лет (СДВГ, ночной энурез) — кардинальное сокращение проблемы, стал спокойнее и собраннее.",
  }
];
